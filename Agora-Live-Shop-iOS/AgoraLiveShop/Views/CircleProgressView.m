...
- (void)initData
{
    ...
    self.textColor = [[UIColor alloc] initWithRed:222.0/255.0 green:17.0/255.0 blue:100.0/255.0 alpha:1];
    self.textFont = [UIFont systemFontOfSize:22 weight:UIFontWeightHeavy];//[UIFont systemFontOfSize:20];
}
