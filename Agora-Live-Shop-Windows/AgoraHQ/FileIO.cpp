...
__IMPLEMENT_INICONFIG_FUN(CConfigHQ, AdvertiseUid, INI_LoginInfo, INI_LoginInfo_AdvertiseUid)
__IMPLEMENT_INICONFIG_FUN(CConfigHQ, AdvertiseCameraDeviceID, INI_LoginInfo, INI_LoginInfo_AdvertiseCameraDeviceId)
__IMPLEMENT_INICONFIG_FUN(CConfigHQ, AdvertiseCameraDeviceName, INI_LoginInfo, INI_LoginInfo_AdvertiseCameraDeviceName)
__IMPLEMENT_INICONFIG_FUN(CConfigHQ, AdvertiseVideoProfile, INI_LoginInfo, INI_LoginInfo_AdvertiseVideoProfile)
