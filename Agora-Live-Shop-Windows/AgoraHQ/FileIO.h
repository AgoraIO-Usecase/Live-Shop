...
//
#define INI_LoginInfo_AdvertiseUid								"AdvertiseUid"
#define INI_LoginInfo_AdvertiseCameraDeviceId				    "AdvertiseCameraDeviceID"
#define INI_LoginInfo_AdvertiseCameraDeviceName				    "AdvertiseCameraDeviceName"
#define INI_LoginInfo_AdvertiseVideoProfile					    "AdvertiseVideoProfile"
...
class CConfigHQ:public CIniBase
{
public:
	CConfigHQ();
	CConfigHQ(const std::string &path);
	~CConfigHQ();
...
public:
	...
	__DECLARE_INICONFIG_FUN(AdvertiseUid)
	__DECLARE_INICONFIG_FUN(AdvertiseCameraDeviceID)
	__DECLARE_INICONFIG_FUN(AdvertiseCameraDeviceName)
	__DECLARE_INICONFIG_FUN(AdvertiseVideoProfile)
